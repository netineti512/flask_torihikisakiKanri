...
class TTorihikiDAO:
    ...
    def insertTTorihiki(self) -> None:
        ...
        sqlList: list = [f'INSERT INTO {self.TABLENAME} values("0001", "ゴールド工業", "ゴールドコウギョウ", "1", "08011112222", "電池","1", "639-1101", "大阪府北区", "中之島ビル", "営業課", "斉藤", "09011112222", "1", "1", "2024/12/12", "2025/12/24", "追加あり", "0", "{str(today)}", "admin", "", "")',
                   f'INSERT INTO {self.TABLENAME} values("0002", "東京コンピュータサービス", "ゴールドコウギョウ", "1", "08011112222", "電池","1", "639-1101", "大阪府北区", "中之島ビル", "営業課", "斉藤", "09011112222", "1", "1", "2024/12/12", "2025/12/24", "追加あり", "0", "{str(today)}", "admin", "", "")',
                   f'INSERT INTO {self.TABLENAME} values("0003", "関西電力", "ゴールドコウギョウ", "1", "08011112222", "電池","1", "639-1101", "大阪府北区", "中之島ビル", "営業課", "斉藤", "09011112222", "1", "1", "2024/12/12", "2025/12/24", "追加あり", "0", "{str(today)}", "admin", "", "")',
                   f'INSERT INTO {self.TABLENAME} values("0004", "TIS株式会社", "ゴールドコウギョウ", "1", "08011112222", "電池","1", "639-1101", "大阪府北区", "中之島ビル", "営業課", "斉藤", "09011112222", "1", "1", "2024/12/12", "2025/12/24", "追加あり", "0", "{str(today)}", "admin", "", "")',
                   f'INSERT INTO {self.TABLENAME} values("0005", "NTT Data", "ゴールドコウギョウ", "1", "08011112222", "電池","1", "639-1101", "大阪府北区", "中之島ビル", "営業課", "斉藤", "09011112222", "1", "1", "2024/12/12", "2025/12/24", "追加あり", "0", "{str(today)}", "admin", "", "")',
                   f'INSERT INTO {self.TABLENAME} values("0006", "関電システムズ", "ゴールドコウギョウ", "1", "08011112222", "電池","1", "639-1101", "大阪府北区", "中之島ビル", "営業課", "斉藤", "09011112222", "1", "1", "2024/12/12", "2025/12/24", "追加あり", "0", "{str(today)}", "admin", "", "")']
